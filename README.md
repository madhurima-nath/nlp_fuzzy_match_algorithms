...
6. [Data camp tutorial - fuzzy string matching](https://www.datacamp.com/community/tutorials/fuzzy-string-python)
7. [Levenshtein python modeule](https://pypi.org/project/python-Levenshtein/)
8. [Article on record linking and fuzzy matching](https://pbpython.com/record-linking.html)
9. [Medium post on Levenshtein distance](https://blog.paperspace.com/measuring-text-similarity-using-levenshtein-distance/)
10. https://www.rosette.com/blog/overview-fuzzy-name-matching-techniques/
